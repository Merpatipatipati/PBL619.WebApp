        ...
        <div class="flex-1 p-10 bg-white">
            ...
            <div class="flex-1 bg-white p-6">
                ...
                <div class="bg-white shadow-md rounded-lg overflow-x-auto mb-8">
                    <table class="min-w-full divide-y divide-gray-200 text-sm">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $leaderboard; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border-t">
                                ...
                                <td class="py-4 px-6 text-center"><?php echo e($entry->id); ?></td>
                                <td class="py-4 px-6 text-center"><?php echo e($entry->username); ?></td>
                                <td class="py-4 px-6 text-center"><?php echo e($entry->level); ?></td>
                                <td class="py-4 px-6 text-center"><?php echo e($entry->poin); ?></td>
                                <td class="py-4 px-6 text-center"><?php echo e($entry->coin); ?></td>
                            </tr>
            ...
            <script>
                ...
                const weeklyPlayerData = {
                    labels: <?php echo json_encode($weeklyPlayerData['weeks'], 15, 512) ?>,
                    counts: <?php echo json_encode($weeklyPlayerData['player_counts'], 15, 512) ?>
                };
...
</html><?php /**PATH /home/boemi/Documents/Kuliah/pblsem6/hydrogami-backend/Admin-HydroGami/resources/views/dashboard-admin.blade.php ENDPATH**/ ?>