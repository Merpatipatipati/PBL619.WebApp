...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(asset('android-chrome-512x512.png')); ?>">
    ...
    <div class="flex justify-center items-center h-screen">
        <div class="bg-white p-10 rounded-lg shadow-md text-center" style="width: 900px;">
            <div class="flex justify-center mb-4">
                <img src="<?php echo e(asset('images/logo-hydrogami.png')); ?>" alt="HydroGami Logo" class="w-24">
            </div>
            ...
            <form action="<?php echo e(route('login-admin')); ?>" method="POST" class="mt-4">
                <?php echo csrf_field(); ?>
            ...
            <p class="mt-4">Belum Punya Akun? <a href="<?php echo e(route('register-admin')); ?>"
...
</html><?php /**PATH /home/boemi/Documents/Kuliah/pblsem6/hydrogami-backend/Admin-HydroGami/resources/views/login-admin.blade.php ENDPATH**/ ?>