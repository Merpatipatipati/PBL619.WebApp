    ...
    <div class="flex min-h-screen">
        ...
        <div class="w-1/5 bg-custom-green text-white p-6 z-10 flex flex-col">
            ...
            <nav class="space-y-4">
                ...
                <a href="<?php echo e(route('leaderboard-admin')); ?>" class="flex items-center py-2 px-4 hover:bg-green-300 rounded">
                    <svg class="w-5 h-5 mr-2 text-white" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
...
</html><?php /**PATH /home/boemi/Documents/Kuliah/pblsem6/hydrogami-backend/Admin-HydroGami/resources/views/misi/create.blade.php ENDPATH**/ ?>