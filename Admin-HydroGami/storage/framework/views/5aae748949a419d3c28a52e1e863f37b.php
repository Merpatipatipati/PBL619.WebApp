        ...
        <div class="w-1/5 bg-custom-green text-white p-6 z-10 flex flex-col">
            <div class="mb-8">
                <div class="flex justify-center mb-4">
                    <img src="<?php echo e(asset('images/logo-hydrogami2.png')); ?>" alt="HydroGami Logo" class="w-28">
                </div>
            </div>
            <nav class="space-y-4">
                <a href="<?php echo e(route('dashboard-admin')); ?>" class="flex items-center py-2 px-4 hover:bg-green-300 rounded">
                ...
                <a href="<?php echo e(route('misi.index')); ?>"
                ...
                <a href="<?php echo e(route('reward.index')); ?>" class="flex items-center py-2 px-4 hover:bg-green-300 rounded">
                ...
                <a href="<?php echo e(route('leaderboard-admin')); ?>"
                ...
                <a href="<?php echo e(route('panduan.index')); ?>" class="flex items-center py-2 px-4 hover:bg-green-300 rounded">
                    <svg class="w-5 h-5 mr-2 text-white" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M5 3a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V5a2 2 0 00-2-2H5zm3 3h4a1 1 0 010 2H8a1 1 0 010-2z" />
        ...
        <div class="flex-1 p-10 bg-white">
            <div class="flex justify-between items-center mb-8">
                ...
                <div class="relative">
                    <button class="flex items-center space-x-4 focus:outline-none">
                        ...
                        <img src="<?php echo e(asset('images/user.png')); ?>" alt="Profile" class="w-12 h-12 rounded-full border-2"
            ...
            <div id="logoutModal"
                ...
                <div class="bg-white p-6 rounded-lg w-80 text-center">
                    ...
                    <div class="flex justify-between mt-6">
                        <a href="<?php echo e(route('login-admin')); ?>" class="bg-custom-green text-white px-4 py-2 rounded">Ya,
                            Logout</a>
            ...
            <div class="flex-1 bg-white p-6">
                ...
                <div class="flex justify-between items-center mb-8">
                    ...
                    <a href="<?php echo e(route('misi.create')); ?>"
                    ...
                    <table class="min-w-full divide-y divide-gray-200 text-sm">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <?php $__currentLoopData = $missions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50" data-mission-id="<?php echo e($mission->id_misi); ?>">
                                    <td class="py-3 px-4 text-center font-medium">
                                        <?php echo e($loop->iteration); ?>

                                    </td>
                                    <td class="py-3 px-4 text-center">
                                        <?php echo e($mission->nama_misi); ?>

                                    </td>
                                    <td class="py-3 px-4 text-justify">
                                        <?php echo e(Str::limit($mission->deskripsi_misi, 80)); ?>

                                    </td>
                                    <td class="py-3 px-4 text-center">
                                        <span class="inline-flex min-w-[90px] justify-center items-center px-2.5 py-0.5 rounded-full text-xs font-semibold whitespace-nowrap <?php echo e($mission->status_misi === 'aktif' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>"><?php echo e(ucfirst($mission->status_misi)); ?></span>
                                    </td>
                                    <td class="py-3 px-4 text-center">
                                        <span
                                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold
                                <?php echo e($mission->tipe_misi === 'harian' ? 'bg-blue-100 text-blue-800' : 'bg-indigo-100 text-indigo-800'); ?>">
                                            <?php echo e(ucfirst($mission->tipe_misi)); ?>

                                        </span>
                                    </td>
                                    <td class="py-3 px-4 text-center text-yellow-600 font-semibold">
                                        <?php echo e($mission->poin); ?> Poin
                                    </td>
                                    <td class="py-3 px-4">
                                        <div class="flex justify-center gap-2">
                                            <a href="<?php echo e(route('misi.edit', $mission->id_misi)); ?>"
                                            ...
                                            <button onclick="openDeleteModal(<?php echo e($mission->id_misi); ?>)"
...
</html><?php /**PATH /home/boemi/Documents/Kuliah/pblsem6/hydrogami-backend/Admin-HydroGami/resources/views/misi/index.blade.php ENDPATH**/ ?>