    ...
    <div class="flex min-h-screen">
        ...
        <div class="w-1/5 bg-custom-green text-white p-6 z-10 flex flex-col">
            ...
            <nav class="space-y-4">
                ...
                <a href="<?php echo e(route('misi.index')); ?>" class="flex items-center py-2 px-4 hover:bg-green-300 rounded">
                    <svg class="w-5 h-5 mr-2 text-white" fill="currentColor" viewBox="0 0 20 20">
                        <path
        ...
        <div class="flex-1 p-10 bg-white">
            ...
            <div class="flex-1 bg-white p-6">
                <div class="flex justify-between items-center mb-8">
                    ...
                    <a href="<?php echo e(route('reward.create')); ?>"
                    ...
                    <table class="min-w-full divide-y divide-gray-200 text-sm">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <?php $__currentLoopData = $rewards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rw): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50" data-reward-id="<?php echo e($rw->id_reward); ?>">
                                    <td class="py-3 px-4 text-center font-medium"><?php echo e($loop->iteration); ?></td>

                                    <!-- Tipe -->
                                    <td class="py-3 px-4 text-center">
                                        <span
                                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold
                                                    <?php echo e($rw->tipe_reward === 'gacha' ? 'bg-blue-100 text-blue-800' : 'bg-indigo-100 text-indigo-800'); ?>">
                                            <?php echo e(ucfirst($rw->tipe_reward)); ?>
                                    ...
                                    <!-- Subtipe -->
                                    <td class="py-3 px-4 text-center">
                                        <?php echo e($rw->subtipe_gacha ? ucfirst($rw->subtipe_gacha) : '-'); ?>

                                    </td>

                                    <!-- Jumlah -->
                                    <td class="py-3 px-4 text-center text-yellow-600 font-semibold">
                                        <?php if($rw->tipe_reward === 'redeem'): ?>
                                            Rp <?php echo e(number_format($rw->jumlah)); ?>

                                        <?php elseif($rw->subtipe_gacha !== 'zonk'): ?>
                                            <?php echo e(number_format($rw->jumlah)); ?> <?php echo e($rw->subtipe_gacha); ?>
                                    ...
                                    <td class="py-3 px-4 text-center">
                                        <?php if($rw->tipe_reward === 'redeem'): ?>
                                            <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-orange-100 text-orange-800">
                                                ...
                                                <?php echo e(number_format($rw->koin_dibutuhkan ?? 0)); ?>
                                    ...
                                    <td class="py-3 px-4">
                                        <div class="flex justify-center gap-2">
                                            <a href="<?php echo e(route('reward.edit', $rw->id_reward)); ?>"
                                            ...
                                            <button onclick="openDeleteModal(<?php echo e($rw->id_reward); ?>)"
...
</html><?php /**PATH /home/boemi/Documents/Kuliah/pblsem6/hydrogami-backend/Admin-HydroGami/resources/views/reward/index.blade.php ENDPATH**/ ?>