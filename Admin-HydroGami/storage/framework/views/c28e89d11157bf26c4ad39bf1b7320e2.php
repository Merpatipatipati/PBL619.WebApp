...
<body class="bg-custom-green">
    ...
    <div class="flex justify-center items-center h-screen">
        <div class="bg-white p-10 rounded-lg shadow-md text-center" style="width: 900px;">
            ...
            <form action="<?php echo e(route('register-admin')); ?>" method="POST" class="mt-4">
                <?php echo csrf_field(); ?>
            ...
            <p class="mt-4">Sudah Punya Akun? <a href="<?php echo e(route('login-admin')); ?>"
...
</html><?php /**PATH /home/boemi/Documents/Kuliah/pblsem6/hydrogami-backend/Admin-HydroGami/resources/views/register-admin.blade.php ENDPATH**/ ?>